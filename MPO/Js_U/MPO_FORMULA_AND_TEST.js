var MPO_FORMULA_AND_TESTService = {}; 
(function () { 
    var url = "MPO_FORMULA_AND_TESTService.asmx/"; 
 ...
 var tag = '{column:"' + column + '",keyword:"' + keyword + '"}';
  ...
  this.Search = function (PageIndex,PageSize,SortExpression,SortDirection,PR_FORMULA_AND_TEST,FORMULA_AND_TEST_DEC,RederTable_Pagger) {
        var result;

        var tag = '{PageIndex:"'+PageIndex+'",PageSize:"'+PageSize+'",SortExpression:"'+SortExpression+'",SortDirection:"'+SortDirection+'",PR_FORMULA_AND_TEST:"' + PR_FORMULA_AND_TEST + '",FORMULA_AND_TEST_DEC:"' + FORMULA_AND_TEST_DEC + '"}';
...
this.Save = function(PR_FORMULA_AND_TEST,FORMULA_AND_TEST_DEC)
{

            var result;

            var tag = '{PR_FORMULA_AND_TEST:"' + PR_FORMULA_AND_TEST + '",FORMULA_AND_TEST_DEC:"' + FORMULA_AND_TEST_DEC + '"}';
            var F = CallServices(url + "Save", tag, false, function(msg) {
                result = msg.d;
            });
            return result;
        };//Save
this.Update = function(PR_FORMULA_AND_TEST,FORMULA_AND_TEST_DEC)
{
...
this.Delete = function(PR_FORMULA_AND_TEST,FORMULA_AND_TEST_DEC)
{
    ...
    this.Select = function (PR_FORMULA_AND_TEST) {
        var result;

 var tag = '{PR_FORMULA_AND_TEST:"'+PR_FORMULA_AND_TEST+'"}';
        var F = CallServices(url + "Select", tag, false, function (msg) {
            result = msg.d;
        });
        return result;
    };//SelectAll
}).apply(MPO_FORMULA_AND_TESTService); 
